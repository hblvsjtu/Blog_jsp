...
<html>
    ...
    <link rel="stylesheet" type="text/css" href="/Blog_jsp/css/libraryContainer.css">
    <link rel="stylesheet" type="text/css" href="/Blog_jsp/css/commentContainer.css">
    <link rel="stylesheet" type="text/css" href="/Blog_jsp/css/animation.css">
    <script type="text/javascript"  src="/Blog_jsp/js/pretreatment.js"></script>
    <script type="text/javascript" src="/Blog_jsp/js/treatment.js" ></script>
	    ...
	    <div id="myAside">
	        ...
	        <div id="myAudio">
	            <audio id="music"  controls="controls" onmousemove="this.play()" onmouseout="this.pause()" preload="auto">
	                <source src="/Blog_jsp/music/anjing.wav" type="audio/wav">
	            </audio>
	        </div>
	...
	<div id="library">
		<div id="bookInfor">
			<form id="formBookInfor" action="<%= request.getContextPath()%>/AddServlet" target="_blank" method="post">
		...
		<div id="checkEmailAndPhone">
	        ...
	        <form id="checkForm"  action="/Blog_jsp/jsp/mailCheck.jsp" method="post" target="_blank">
	            <table id="checkTable">
	...
	<div id="commentContainer">
	    <div id="videoArea">
	        <video id="video" width="600px" height="400px"  onmousemove="this.play()" onmouseout="this.pause()" preload="metadata"  controls="controls"
	            ...
	            <source src="/Blog_jsp/video/video.mp4" type="video/mp4">
	        </video>
