...
<html>
		...
		<c:choose>
			...
			<c:when test="${('falseTag'eq isFromFunctionCheckExistedUser) && ('trueTag' eq fromPageSignUpCheckServlet) && ('trueTag' eq isSignUpFinish) && ('falseTag' eq isExisted) && ('trueTag' eq signUpFlag)}">
				<script type="text/javascript" charset="UTF-8">
						 ...
						 window.location.href="../SignInCheckServlet?fromPage=signUp";
				</script>
			</c:when>
	...
	isSignUpFinish: <c:out value="isSignUpFinish"></c:out>
		<div align="center">
			<div class="div1">
				<form name="formSignUp" id="formSignUp" action="../SignUpCheckServlet" method="post" onsubmit="return reg(this);">
					<table>
						<tr>
